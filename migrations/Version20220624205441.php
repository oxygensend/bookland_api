 ...
 */
final class Version20220624205441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD publication_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', ADD author VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP publication_date, DROP author');
    }
}
